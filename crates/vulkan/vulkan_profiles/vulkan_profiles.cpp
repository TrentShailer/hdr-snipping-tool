...
#ifdef VP_HDR_SNIPPING_TOOL_requirements
namespace VP_HDR_SNIPPING_TOOL_REQUIREMENTS {
    ...
    [](VkBaseOutStructure* p) { (void)p;
            switch (p->sType) {
                ...
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES_KHR: {
                    VkPhysicalDeviceDynamicRenderingFeaturesKHR* s = static_cast<VkPhysicalDeviceDynamicRenderingFeaturesKHR*>(static_cast<void*>(p));
                ...
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES: {
                    VkPhysicalDeviceScalarBlockLayoutFeatures* s = static_cast<VkPhysicalDeviceScalarBlockLayoutFeatures*>(static_cast<void*>(p));
...
static const VpStructChainerDesc chainerDesc = {
    [](VkBaseOutStructure* p, void* pUser, PFN_vpStructChainerCb pfnCb) {
        ...
        VkPhysicalDeviceDynamicRenderingFeaturesKHR physicalDeviceDynamicRenderingFeaturesKHR{ VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES_KHR, &physicalDeviceTimelineSemaphoreFeatures };
        VkPhysicalDeviceScalarBlockLayoutFeatures physicalDeviceScalarBlockLayoutFeatures{ VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES, &physicalDeviceDynamicRenderingFeaturesKHR };
        p->pNext = static_cast<VkBaseOutStructure*>(static_cast<void*>(&physicalDeviceScalarBlockLayoutFeatures));
        pfnCb(p, pUser);
    },
    [](VkBaseOutStructure* p, void* pUser, PFN_vpStructChainerCb pfnCb) {
        VkPhysicalDevicePushDescriptorPropertiesKHR physicalDevicePushDescriptorPropertiesKHR{ VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR, nullptr };
...
static const VpFormatDesc formatDesc[] = {
    {
        ...
        [](VkBaseOutStructure* p) { (void)p;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2_KHR: {
                    ...
                    s->formatProperties.optimalTilingFeatures |= (VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT);
                } break;
                default: break;
            }
        },
        [](VkBaseOutStructure* p) -> bool { (void)p;
            ...
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2_KHR: {
                    VkFormatProperties2KHR* s = static_cast<VkFormatProperties2KHR*>(static_cast<void*>(p));
                    ret = ret && (vpCheckFlags(s->formatProperties.optimalTilingFeatures, (VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT)));
                } break;
                default: break;
            }
            return ret;
    ...
    },
    {
        ...
        [](VkBaseOutStructure* p) { (void)p;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2_KHR: {
                    VkFormatProperties2KHR* s = static_cast<VkFormatProperties2KHR*>(static_cast<void*>(p));
                    s->formatProperties.optimalTilingFeatures |= (VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT | VK_FORMAT_FEATURE_STORAGE_IMAGE_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT);
                } break;
                default: break;
            }
        },
        [](VkBaseOutStructure* p) -> bool { (void)p;
            ...
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2_KHR: {
                    VkFormatProperties2KHR* s = static_cast<VkFormatProperties2KHR*>(static_cast<void*>(p));
                    ret = ret && (vpCheckFlags(s->formatProperties.optimalTilingFeatures, (VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT | VK_FORMAT_FEATURE_STORAGE_IMAGE_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT)));
                } break;
                default: break;
            }
            return ret;
    ...
    },
    {
        ...
        [](VkBaseOutStructure* p) { (void)p;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2_KHR: {
                    VkFormatProperties2KHR* s = static_cast<VkFormatProperties2KHR*>(static_cast<void*>(p));
                    s->formatProperties.optimalTilingFeatures |= (VK_FORMAT_FEATURE_TRANSFER_SRC_BIT | VK_FORMAT_FEATURE_STORAGE_IMAGE_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT);
                } break;
                default: break;
            }
        },
        [](VkBaseOutStructure* p) -> bool { (void)p;
            ...
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2_KHR: {
                    VkFormatProperties2KHR* s = static_cast<VkFormatProperties2KHR*>(static_cast<void*>(p));
                    ret = ret && (vpCheckFlags(s->formatProperties.optimalTilingFeatures, (VK_FORMAT_FEATURE_TRANSFER_SRC_BIT | VK_FORMAT_FEATURE_STORAGE_IMAGE_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT | VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT)));
                } break;
                default: break;
            }
            return ret;
...
#endif // VP_HDR_SNIPPING_TOOL_requirements

#ifdef VP_HDR_SNIPPING_TOOL_requirements_debug
namespace VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG {
...
#endif // VP_HDR_SNIPPING_TOOL_requirements_debug
...
namespace VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG {
    ...
    namespace blocks {
        namespace debug {
            static const VpVariantDesc variants[] = {
                {
                    "debug",
                    static_cast<uint32_t>(std::size(blocks::debug::instanceExtensions)), blocks::debug::instanceExtensions,
                    0, nullptr,
                    0, nullptr,
                    blocks::debug::featureDesc,
                    0, nullptr,
                    blocks::debug::propertyDesc,
                    0, nullptr,
                    0, nullptr,
                    0, nullptr,
                    0, nullptr,
                    blocks::debug::chainerDesc,
                    0, nullptr,
                },
            };
            static const uint32_t variantCount = static_cast<uint32_t>(std::size(variants));
    ...
    static const VpCapabilitiesDesc capabilities[] = {
        { blocks::debug::variantCount, blocks::debug::variants },
    };
    static const uint32_t capabilityCount = static_cast<uint32_t>(std::size(capabilities));
} // namespace VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG
#endif //VP_HDR_SNIPPING_TOOL_requirements_debug
...
#ifdef VP_HDR_SNIPPING_TOOL_requirements
    VpProfileDesc{
        VpProfileProperties{ VP_HDR_SNIPPING_TOOL_REQUIREMENTS_NAME, VP_HDR_SNIPPING_TOOL_REQUIREMENTS_SPEC_VERSION },
        VP_HDR_SNIPPING_TOOL_REQUIREMENTS_MIN_API_VERSION,
        VP_HDR_SNIPPING_TOOL_REQUIREMENTS::mergedCapabilities,
        0, nullptr,
        VP_HDR_SNIPPING_TOOL_REQUIREMENTS::capabilityCount, VP_HDR_SNIPPING_TOOL_REQUIREMENTS::capabilities,
        0, nullptr,
    },
#endif // VP_HDR_SNIPPING_TOOL_REQUIREMENTS
#ifdef VP_HDR_SNIPPING_TOOL_requirements_debug
    VpProfileDesc{
        VpProfileProperties{ VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG_NAME, VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG_SPEC_VERSION },
        VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG_MIN_API_VERSION,
        VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG::mergedCapabilities,
        0, nullptr,
        VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG::capabilityCount, VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG::capabilities,
        0, nullptr,
    },
#endif // VP_HDR_SNIPPING_TOOL_REQUIREMENTS_DEBUG
};
