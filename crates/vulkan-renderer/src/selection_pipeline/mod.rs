...
use vulkano::{
    pipeline::{
        graphics::{color_blend::AttachmentBlend, vertex_input::VertexDefinition},
...
pub mod vertex_shader {
    vulkano_shaders::shader! {
        ty: "vertex",
        bytes: "src/selection_pipeline/shaders/vertex.spv"
    }
}
...
pub mod fragment_shader {
    vulkano_shaders::shader! {
        ty: "fragment",
        bytes: "src/selection_pipeline/shaders/fragment.spv"
    }
}
