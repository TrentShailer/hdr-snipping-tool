...
impl Border {
    ...
    pub fn render(
        ...
        >,
        border_points: [u32; 4], // ltrb
        window_size: PhysicalSize<u32>,
    ) -> Result<(), Box<ValidationError>> {
        // Convert seleciton to -1.0, 1.0
        let l = (border_points[0] as f32 / window_size.width as f32) * 2.0 - 1.0;
        let t = (border_points[1] as f32 / window_size.height as f32) * 2.0 - 1.0;
        let r = (border_points[2] as f32 / window_size.width as f32) * 2.0 - 1.0;
        let b = (border_points[3] as f32 / window_size.height as f32) * 2.0 - 1.0;
        let border_points = [l, t, r, b];
